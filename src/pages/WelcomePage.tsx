...
export const WelcomePage = () => {
    ...
    const schemaData = {
        ...
        operatingSystem: 'Web',
        description:
            'Sistema de gestión para bares y restaurantes. POS, Menú QR, Pedidos, Gestión de Caja, Productos y más.',
        offers: {
            '@type': 'Offer',
            price: '17000',
            priceCurrency: 'ARS',
    ...
    return (
        <>
            <Helmet>
                <title>
                    SimpleBar | Sistema de Gestión para Bares y Restaurantes
                </title>
                <meta
                    name="description"
                    content="Unificá POS, Menú QR, Pedidos, Gestión de Caja, Productos y más en un solo sistema. Interfaz intuitiva, soporte en español y onboarding en minutos."
                />
