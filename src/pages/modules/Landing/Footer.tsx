            ...
            <div className="mx-auto flex max-w-7xl flex-col-reverse items-center justify-between gap-6 px-4 sm:flex-row sm:items-start sm:px-6 lg:px-8">
                ...
                <div className="flex w-full flex-col items-center gap-4 sm:w-auto sm:items-end">
                    ...
                    <div className="flex gap-3">
                        <a
                            href="https://www.facebook.com/profile.php?id=61571168216826"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex size-9 items-center justify-center rounded-full border border-neutral-300 text-neutral-600 transition-colors hover:border-primary hover:text-primary dark:border-neutral-700 dark:text-neutral-400 dark:hover:border-primary dark:hover:text-primary"
                            aria-label="Facebook"
                        >
                        ...
                        <a
                            href="https://www.instagram.com/simple.bar.ar/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex size-9 items-center justify-center rounded-full border border-neutral-300 text-neutral-600 transition-colors hover:border-primary hover:text-primary dark:border-neutral-700 dark:text-neutral-400 dark:hover:border-primary dark:hover:text-primary"
