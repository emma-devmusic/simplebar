...
export const CartTable = ({
    ...
    return (
        <div className="overflow-x-auto overflow-y-auto rounded-lg border border-gray-200 text-sm md:max-h-[42vh] 2xl:max-h-[50vh]">
            <table className="relative w-full divide-y-2 divide-gray-200 bg-white">
                <thead className="sticky top-0 z-10 w-full bg-white text-left">
                    <tr>
