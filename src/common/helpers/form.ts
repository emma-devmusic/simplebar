...
export const OBJECT_LABELS_FIELDS:Record<FiledsForm, string> = {
    ...
    dni: 'DNI',
    cell_phone: 'Teléfono',
    cell_phone_secondary:'Télefono secundario',
    address: 'Dirección',
    age: 'Edad',
    gender_type: 'Género',
...
export const OBJECT_PLACEHOLDERS_FIELDS:Record<FiledsForm, string> = {
    ...
    cell_phone_bussines: 'Ingresa el teléfono de tu empresa',
...
export const formValidate = (
    formData: FormsInputs = initialObjValidate,
    ...
    if (requiredFields.includes('lastname') && !formData.last_name) {
    ...
    if (requiredFields.includes('phone_bussines') && !formData.cell_phone_bussines) {
